iedMkr=["IED_1", "IED_2", "IED_3", "IED_4", "pass_1", "pass_2", "pass_3"];	//List of markers to spawn IEDs in
iedNum=4;								//Number of IEDs per marker, defined in iedMkr	[Default: 5]
...
iedJunk=["Land_JunkPile_F","Land_GarbageContainer_closed_F","Land_GarbageBags_F,Land_Tyres_F","Land_GarbagePallet_F","Land_Basket_F,Land_Sack_F","Land_Sacks_goods_F","Land_Sacks_heap_F","Land_BarrelTrash_F"];
...
sleep 5;
{CIVILIAN revealMine _x;EAST revealMine _x;resistance revealMine _x;}forEach allMines;